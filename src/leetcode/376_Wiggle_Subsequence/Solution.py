...
class Solution:
    def wiggleMaxLength(self, nums: List[int]) -> int:
        ...
        # q = [res[i]-res[i-1] > 0 for i in range(1, len(res))]
        # q2 = [q[i] != q[i - 1] for i in range(1, len(q))]
        #
        # print([(res[i], q2[i]) for i in range(len(q2))])
